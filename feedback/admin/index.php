...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" type="text/css" href="public_blog/css_login.css">
  <script src="https://code.jquery.com/jquery-3.4.1.js"></script>
<link href="public_blog/style.css" rel="stylesheet" type="text/css">

</head>


<body>
<div class="full-landing-img"></div>
<form action="checklogin.php" method="post" id="form_login">
 ...
 <div class="inputGroup inputGroup2">
    <label >Email</label>
    <input required  name="email" placeholder="username" type="email" title="username" />
  </div>
  ...
  <p style="color: red;"><?php if (isset($_COOKIE['msg-go-login'])) {
    echo $_COOKIE['msg-go-login'];
  } ?></p>
  <div class="inputGroup inputGroup3">
    <button class="btn btn-block btn-process" name="login" type="submit" value=" Login " style="cursor: pointer;"> Login </button>
  </div> 
</form>
</body>
</html>
...
<script type="text/javascript" src="public_blog/js/js_login.js"></script>
<script src="http://www.jqueryscript.net/demo/jQuery-Plugin-For-Water-Ripple-Animation-ripples/js/jquery.ripples.js">
</script> 
<script type="text/javascript" src="public_blog/js/jquery.vide.min.js"></script>
